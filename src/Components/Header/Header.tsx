...
function Header() {
  ...
  useEffect(() => {
    ...
    setUserType(userDataParse.type);
    if (userDataParse.type === "Company") {
      setUserName(userDataParse.company_name);
    } else if (userDataParse.type === "Candidate") {
      ...
      <div className="sticky-header main-bar-wraper navbar-expand-lg">
        <div className="main-bar clearfix">
          <div className="container clearfix">
            ...
            >
              <div className="logo-header mostion d-md-block d-lg-none"></div>
              <ul className="nav navbar-nav">
                ...
                >
                  <Link to="/browse-job-list">Browse Job</Link>
                </li>
                <li
