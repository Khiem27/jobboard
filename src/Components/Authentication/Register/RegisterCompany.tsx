...
import { CompanyData } from "../../../Shared/types";
import { RegisterCompanySliceAction } from "./RegisterCompanySlice";
  ...
  const onSubmit = async (data: UserInputs) => {
    try {
      const userData: CompanyData = {
        company_name: data.registerUserName,
        email: data.registerEmail,
        password: data.registerPassword,
      };
      const resultAction: any = await dispatch(
        RegisterCompanySliceAction(userData)
      );
            ...
            <div id="login" className="tab-pane active ">
              ...
              >
                ...
                <div className="form-group text-left">
                  ...
                  >
                    <i className="fa fa-unlock-alt"></i> You are a candidate?
                  </Link>
                </div>
              </form>
